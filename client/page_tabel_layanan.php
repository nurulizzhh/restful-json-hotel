                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    $no = 1;
                                    $data_array = $abc->tampil_semua_layanan();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success"
                                                    href="page_edit_layanan.php?id_layanan=<?= $r->id_layanan ?>"><i
                                                        class="bi bi-pencil-square"></i>Ubah</a>

                                                <a class="btn btn-danger"
                                                    href="proses_layanan.php?aksi=hapus&id_layanan=<?= $r->id_layanan ?>"
                            ...
                            <a class="btn btn-primary" href="page_tambah_layanan.php"><i
                                        class="bi bi-plus-square"></i> Tambah Layanan</a>
                        </div>
                    </div>
