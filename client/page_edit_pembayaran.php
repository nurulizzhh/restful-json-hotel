                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            $r = $abc->tampil_pembayaran($_GET['id_pembayaran']);
                            ?>
                            ...
                            <form method="POST" action="proses_pembayaran.php">
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">ID pembayaran</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?= $r->id_pembayaran ?>"
                                            disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">ID Pemesanan</label>
                                    <div class="col-sm-10">
                                        <input type="hidden" name="id_pemesanan" value="<?= $r->id_pemesanan ?>" />
                                        <input type="text" name="id_pemesanan" class="form-control"
                                            value="<?= $r->id_pemesanan ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="total_pembayaran" class="form-control"
                                            value="<?= $r->total_pembayaran ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">Tanggal Pembayaran</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tgl_pembayaran" class="form-control"
                                            value="<?= $r->tgl_pembayaran ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
