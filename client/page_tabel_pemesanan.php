                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success"
                                                    href="page_edit_pemesanan.php?id_pemesanan=<?= $r->id_pemesanan ?>"><i
                                                        class="bi bi-pencil-square"></i>Ubah</a>

                                                <a class="btn btn-danger"
                                                    href="proses_pemesanan.php?aksi=hapus&id_pemesanan=<?= $r->id_pemesanan ?>"
                            ...
                            <a class="btn btn-primary" href="page_pemesanan.php"><i class="bi bi-plus-square"></i>
                                Tambah Pemesanan</a>
                        </div>
                    </div>
