        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
              ...
              $r = $abc->tampil_pemesanan($_GET['id_pemesanan']);
              ?>
              <h5 class="card-title">Masukkan data</h5>
              <form method="POST" action="proses_pemesanan.php">
                <input type="hidden" name="aksi" value="ubah" />
                <input type="hidden" name="id_pemesanan" value="<?= $r->id_pemesanan ?>" />
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama_pemesan" class="form-control" value="<?= $r->nama_pemesan ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Check In</label>
                  <div class="col-sm-10">
                    <input type="text" name="tgl_checkin" class="form-control" value="<?= $r->tgl_checkin ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Check Out</label>
                  <div class="col-sm-10">
                    <input type="text" name="tgl_checkout" class="form-control" value="<?= $r->tgl_checkout ?>">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="id_kamar" id="no_kamar">
                      <?php
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" name="id_layanan" id="nama_layanan" value="<?= $r->nama_layanan ?>">
                      <?php
